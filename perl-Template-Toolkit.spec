...
Source0  : https://cpan.metacpan.org/authors/id/A/AT/ATOOMIC/Template-Toolkit-3.004.tar.gz
...
%prep
%setup -q -n Template-Toolkit-3.004
cd %{_builddir}/Template-Toolkit-3.004
