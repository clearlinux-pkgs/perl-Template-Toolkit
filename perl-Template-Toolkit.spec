...
Version  : 2.29
Release  : 1
URL      : https://cpan.metacpan.org/authors/id/A/AT/ATOOMIC/Template-Toolkit-2.29.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/A/AT/ATOOMIC/Template-Toolkit-2.29.tar.gz
Summary  : Perl template processing system
Group    : Development/Tools
License  : Artistic-1.0-Perl
Requires: perl-Template-Toolkit-bin = %{version}-%{release}
Requires: perl-Template-Toolkit-lib = %{version}-%{release}
...
%package lib
Summary: lib components for the perl-Template-Toolkit package.
Group: Libraries

%description lib
lib components for the perl-Template-Toolkit package.
...
%prep
%setup -q -n Template-Toolkit-2.29
